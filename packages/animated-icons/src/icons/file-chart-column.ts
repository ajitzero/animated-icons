...
@Component({
	...
	template: `
		...
		>
			...
			<svg:path class="column column-0" d="M8 18v-1" />
			<svg:path class="column column-1" d="M12 18v-6" />
			<svg:path class="column column-2" d="M16 18v-3" />
		</svg>
	`,
	styles: `
		:host {
	...
	host: {
		'[class]': 'class()',
		'aria-label': 'file-chart-column',
		role: 'img',
		'(mouseenter)': 'handleMouseEnter()',
	},
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FileChartColumnIcon {
