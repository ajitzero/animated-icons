...
@Component({
	selector: 'i-arrow-up-1-0',
	template: `
		<svg
			class="arrow-up-1-0-icon"
			[attr.width]="size()"
			[attr.height]="size()"
			[attr.stroke]="color()"
	...
	styles: `
		...
		.arrow-up-1-0-icon.animate .swap-group-up {
			transform: translateY(10px);
		}

		.arrow-up-1-0-icon.animate .swap-group-down {
			transform: translateY(-10px);
		}
	`,
	host: {
